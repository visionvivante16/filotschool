...
try {
  ...
  switch ($_GET['edit']) {
    ...
    case 'social_login':
      ...
      remove_pending_uploads([$_POST['sngine_app_icon']]);
      break;
    ...
    case 'payments_methods':
      ...
      $_POST['mpesa_enabled'] = (isset($_POST['mpesa_enabled'])) ? '1' : '0';
      /* update */
      update_system_options([
        ...
        'mpesa_enabled'      => secure($_POST['mpesa_enabled']),
				'mpesa_api_key'      => secure($_POST['mpesa_api_key']),
				'mpesa_public_key'   => secure($_POST['mpesa_public_key']),
				'mpesa_service_provider_code' => secure($_POST['mpesa_service_provider_code']),
				'mpesa_env'          => secure($_POST['mpesa_env']) 
      ]);
      break;
