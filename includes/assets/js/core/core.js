...
api['payments/mpesa']  = ajax_path+"payments/mpesa.php";
/* ads */
...
$(function () {
  ...
  $('body').on('click', '.js_payment-stripe', function () {
   ...
   /* M-Pesa */
   $('body').on('click', '.js_payment-mpesa', function () {
      ...
      // 👉 Ask phone number (simple version)
      var phone = prompt("Enter M-Pesa Phone Number (e.g. 25884XXXXXXX)");
      ...
      $.post(api['payments/mpesa'], data, function(response) {
          ...
          var orders_collection_id = response.orderid;
          
          startMpesaPolling(reference,orders_collection_id);

          showMpesaWaiting(reference,orders_collection_id);
          // ✅ SUCCESS MESSAGE
          // modal('#modal-message', {
          //     title: "M-Pesa",
  ...
  function showMpesaWaiting(reference,orders_collection_id) {
  ...
  function startMpesaPolling(reference, orders_collection_id) {
      ...
      var interval = setInterval(function () {
        ...
        $.get('/includes/ajax/payments/check_mpesa_status.php?ref=' + reference + '&orders_collection_id=' + orders_collection_id, function(res) {
              ...
              if(res.paid) {
                  ...
                  setTimeout(function () {
                      location.reload(); // or redirect page
                  }, 2000);
              }
          ...
          if(attempts > 24) {
              ...
              modal('#modal-message', {
                  title: "Pending",
                  message: "Payment not confirmed yet. Please try again."
              });
          }
