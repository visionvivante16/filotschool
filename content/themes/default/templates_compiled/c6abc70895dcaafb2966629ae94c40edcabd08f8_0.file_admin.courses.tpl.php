<?php
/* Smarty version 5.7.0, created on 2026-04-28 05:34:21
  from 'file:admin.courses.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.7.0',
  'unifunc' => 'content_69f046dd4d5240_85079259',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c6abc70895dcaafb2966629ae94c40edcabd08f8' => 
    array (
      0 => 'admin.courses.tpl',
      1 => 1740576253,
      2 => 'file',
...
function content_69f046dd4d5240_85079259 (\Smarty\Template $_smarty_tpl) {
...
/courses" class="btn btn-md btn-light">
    ...
    <?php } elseif ($_smarty_tpl->getValue('sub_view') == "categories") {?>
      <div class="float-end">
        <a href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/<?php echo $_smarty_tpl->getValue('control_panel')['url'];?>
/courses/add_category" class="btn btn-md btn-primary">
    ...
    <?php } elseif ($_smarty_tpl->getValue('sub_view') == "add_category" || $_smarty_tpl->getValue('sub_view') == "edit_category") {?>
      <div class="float-end">
        <a href="<?php echo $_smarty_tpl->getValue('system')['system_url'];?>
/<?php echo $_smarty_tpl->getValue('control_panel')['url'];?>
/courses/categories" class="btn btn-md btn-light">
          <i class="fa fa-arrow-circle-left mr5"></i><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Go Back");?>

        </a>
      </div>
    <?php }?>
    <i class="fa fa-book mr10"></i><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Courses");?>
...
/courses/find" method="get">
        ...
        <div class="form-text small">
          <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Search by Course Title or Description");?>
...
?>
                <tr>
                  ...
                  <td>
                    <a target="_blank" href="<?php echo $_smarty_tpl->getValue('row')['course_author_url'];?>
">
                      <img class="tbl-image" src="<?php echo $_smarty_tpl->getValue('row')['course_author_picture'];?>
">
                      <?php echo $_smarty_tpl->getValue('row')['course_author_name'];?>
...
?>
                <?php $_smarty_tpl->renderSubTemplate('file:__categories.recursive_rows.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('_url'=>"courses",'_handle'=>"courses_category"), (int) 0, $_smarty_current_dir);
?>
              <?php
}
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
...
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
  ...
  <?php } elseif ($_smarty_tpl->getValue('sub_view') == "edit_category") {?>
    ...
    <form class="js_ajax-forms" data-url="admin/courses.php?do=edit_category&id=<?php echo $_smarty_tpl->getValue('data')['category_id'];?>
">
      <div class="card-body">
        <div class="row form-group">
          <label class="col-md-3 form-label">
