        ...
        <form class="js_ajax-forms" data-url="admin/settings.php?edit=payments_methods">
          <div class="card-body">
            ...
            <div>
              <div class="form-table-row">
                <div class="avatar">
                  {include file='__svg_icons.tpl' icon="mpesa" width="40px" height="40px"}
                </div>

                <div>
                  <div class="form-label h6">{__("M-Pesa Enabled")}</div>
                  <div class="form-text d-none d-sm-block">
                    {__("Enable payments via M-Pesa")}
                  </div>
                </div>
                ...
                <div class="text-end">
                  <label class="switch" for="mpesa_enabled">
                    ...
                    {if $system['mpesa_enabled']}checked{/if}>
                    <span class="slider round"></span>
                  </label>
                </div>
              </div>
                ...
                <div class="col-md-9">
                  ...
                  <div class="form-check form-check-inline">
                    <input type="radio"
                          ...
                          {if $system['mpesa_env'] == "sandbox"}checked{/if}>
                  ...
                  <div class="form-check form-check-inline">
                    <input type="radio"
                          ...
                          value="live"
                          class="form-check-input"
                          {if $system['mpesa_env'] == "live"}checked{/if}>
                ...
                <div class="col-md-9">
                  {if !$user->_data['user_demo']}
                    <input type="text"
                          class="form-control"
                          name="mpesa_api_key"
                          value="{$system['mpesa_api_key']}">
                  {else}
                    <input type="password" class="form-control" value="*********">
                  {/if}

                  <div class="form-text">
                    {__("Your M-Pesa API Key")}
                  </div>
                </div>
              </div>
                ...
                <div class="col-md-9">
                  {if !$user->_data['user_demo']}
                    <textarea class="form-control"
                              ...
                              rows="5">{$system['mpesa_public_key']}</textarea>
                  {else}
                    <textarea class="form-control" rows="5">*********</textarea>
                  {/if}

                  <div class="form-text">
                    {__("Paste your M-Pesa public key")}
                  </div>
                </div>
              </div>
              ...
              <div class="row form-group">
                ...
                <div class="col-md-9">
                  <input type="text"
                        ...
                        value="{$system['mpesa_service_provider_code']}">

                  <div class="form-text">
                    {__("Your M-Pesa Service Provider Code")}
                  </div>
                </div>
              </div>
